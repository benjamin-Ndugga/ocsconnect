/**
 * QueryOfferingRentCycleRequestOfferingInstOfferingOwner.java
 *
...
public class QueryOfferingRentCycleRequestOfferingInstOfferingOwner  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode;

    private com.huawei.www.bme.cbsinterface.bcservices.QueryOfferingRentCycleRequestOfferingInstOfferingOwnerAcctAccessCode acctAccessCode;
    ...
    public QueryOfferingRentCycleRequestOfferingInstOfferingOwner() {
    }

    public QueryOfferingRentCycleRequestOfferingInstOfferingOwner(
           com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode,
           com.huawei.www.bme.cbsinterface.bcservices.QueryOfferingRentCycleRequestOfferingInstOfferingOwnerAcctAccessCode acctAccessCode,
    ...
    /**
     * Gets the subAccessCode value for this QueryOfferingRentCycleRequestOfferingInstOfferingOwner.
     * 
    ...
    /**
     * Sets the subAccessCode value for this QueryOfferingRentCycleRequestOfferingInstOfferingOwner.
     * 
     * @param subAccessCode
     */
    ...
    /**
     * Gets the acctAccessCode value for this QueryOfferingRentCycleRequestOfferingInstOfferingOwner.
     * 
     * @return acctAccessCode
     */
    public com.huawei.www.bme.cbsinterface.bcservices.QueryOfferingRentCycleRequestOfferingInstOfferingOwnerAcctAccessCode getAcctAccessCode() {
        return acctAccessCode;
    }


    /**
     * Sets the acctAccessCode value for this QueryOfferingRentCycleRequestOfferingInstOfferingOwner.
     * 
     * @param acctAccessCode
     */
    public void setAcctAccessCode(com.huawei.www.bme.cbsinterface.bcservices.QueryOfferingRentCycleRequestOfferingInstOfferingOwnerAcctAccessCode acctAccessCode) {
        this.acctAccessCode = acctAccessCode;
    }


    /**
     * Gets the custAccessCode value for this QueryOfferingRentCycleRequestOfferingInstOfferingOwner.
     * 
    ...
    /**
     * Sets the custAccessCode value for this QueryOfferingRentCycleRequestOfferingInstOfferingOwner.
     * 
    ...
    /**
     * Gets the subGroupAccessCode value for this QueryOfferingRentCycleRequestOfferingInstOfferingOwner.
     * 
    ...
    /**
     * Sets the subGroupAccessCode value for this QueryOfferingRentCycleRequestOfferingInstOfferingOwner.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryOfferingRentCycleRequestOfferingInstOfferingOwner)) return false;
        QueryOfferingRentCycleRequestOfferingInstOfferingOwner other = (QueryOfferingRentCycleRequestOfferingInstOfferingOwner) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryOfferingRentCycleRequestOfferingInstOfferingOwner.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>QueryOfferingRentCycleRequest>OfferingInst>OfferingOwner"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>>QueryOfferingRentCycleRequest>OfferingInst>OfferingOwner>AcctAccessCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
