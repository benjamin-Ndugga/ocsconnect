/**
 * ActivateProductRequestOfferingOwner.java
 *
...
public class ActivateProductRequestOfferingOwner  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode;

    private com.huawei.www.bme.cbsinterface.bcservices.ActivateProductRequestOfferingOwnerAcctAccessCode acctAccessCode;
    ...
    public ActivateProductRequestOfferingOwner() {
    }

    public ActivateProductRequestOfferingOwner(
           com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode,
           com.huawei.www.bme.cbsinterface.bcservices.ActivateProductRequestOfferingOwnerAcctAccessCode acctAccessCode,
    ...
    /**
     * Gets the subAccessCode value for this ActivateProductRequestOfferingOwner.
     * 
    ...
    /**
     * Sets the subAccessCode value for this ActivateProductRequestOfferingOwner.
     * 
     * @param subAccessCode
     */
    ...
    /**
     * Gets the acctAccessCode value for this ActivateProductRequestOfferingOwner.
     * 
     * @return acctAccessCode
     */
    public com.huawei.www.bme.cbsinterface.bcservices.ActivateProductRequestOfferingOwnerAcctAccessCode getAcctAccessCode() {
        return acctAccessCode;
    }


    /**
     * Sets the acctAccessCode value for this ActivateProductRequestOfferingOwner.
     * 
     * @param acctAccessCode
     */
    public void setAcctAccessCode(com.huawei.www.bme.cbsinterface.bcservices.ActivateProductRequestOfferingOwnerAcctAccessCode acctAccessCode) {
        this.acctAccessCode = acctAccessCode;
    }


    /**
     * Gets the custAccessCode value for this ActivateProductRequestOfferingOwner.
     * 
    ...
    /**
     * Sets the custAccessCode value for this ActivateProductRequestOfferingOwner.
     * 
    ...
    /**
     * Gets the subGroupAccessCode value for this ActivateProductRequestOfferingOwner.
     * 
    ...
    /**
     * Sets the subGroupAccessCode value for this ActivateProductRequestOfferingOwner.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ActivateProductRequestOfferingOwner)) return false;
        ActivateProductRequestOfferingOwner other = (ActivateProductRequestOfferingOwner) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ActivateProductRequestOfferingOwner.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">ActivateProductRequest>OfferingOwner"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>ActivateProductRequest>OfferingOwner>AcctAccessCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
