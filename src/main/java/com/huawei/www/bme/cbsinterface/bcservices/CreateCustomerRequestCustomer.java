/**
 * CreateCustomerRequestCustomer.java
 *
...
public class CreateCustomerRequestCustomer  implements java.io.Serializable {
    /* It is the customer key from request system which this transaction
     * wants to create.
     * It can be same as the RegisterCustKey, or a different customer key
     * (User Customer Key) under the Register Customer. */
    ...
    public CreateCustomerRequestCustomer() {
    }
    ...
    /**
     * Gets the custKey value for this CreateCustomerRequestCustomer.
     * 
     * @return custKey   * It is the customer key from request system which this transaction
     * wants to create.
     * It can be same as the RegisterCustKey, or a different customer key
     * (User Customer Key) under the Register Customer.
     */
    ...
    /**
     * Sets the custKey value for this CreateCustomerRequestCustomer.
     * 
     * @param custKey   * It is the customer key from request system which this transaction
     * wants to create.
     * It can be same as the RegisterCustKey, or a different customer key
     * (User Customer Key) under the Register Customer.
     */
    ...
    /**
     * Gets the custInfo value for this CreateCustomerRequestCustomer.
     * 
     * @return custInfo
     */
    ...
    /**
     * Sets the custInfo value for this CreateCustomerRequestCustomer.
     * 
     * @param custInfo
     */
    ...
    /**
     * Gets the individualInfo value for this CreateCustomerRequestCustomer.
     * 
    ...
    /**
     * Sets the individualInfo value for this CreateCustomerRequestCustomer.
     * 
    ...
    /**
     * Gets the orgInfo value for this CreateCustomerRequestCustomer.
     * 
     * @return orgInfo
     */
    ...
    /**
     * Sets the orgInfo value for this CreateCustomerRequestCustomer.
     * 
     * @param orgInfo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateCustomerRequestCustomer)) return false;
        CreateCustomerRequestCustomer other = (CreateCustomerRequestCustomer) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateCustomerRequestCustomer.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">CreateCustomerRequest>Customer"));
