/**
 * ChangeOfferingStatusRequestOfferingInstOfferingOwner.java
 *
...
public class ChangeOfferingStatusRequestOfferingInstOfferingOwner  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode;

    private com.huawei.www.bme.cbsinterface.bcservices.ChangeOfferingStatusRequestOfferingInstOfferingOwnerAcctAccessCode acctAccessCode;
    ...
    public ChangeOfferingStatusRequestOfferingInstOfferingOwner() {
    }

    public ChangeOfferingStatusRequestOfferingInstOfferingOwner(
           com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode,
           com.huawei.www.bme.cbsinterface.bcservices.ChangeOfferingStatusRequestOfferingInstOfferingOwnerAcctAccessCode acctAccessCode,
    ...
    /**
     * Gets the subAccessCode value for this ChangeOfferingStatusRequestOfferingInstOfferingOwner.
     * 
    ...
    /**
     * Sets the subAccessCode value for this ChangeOfferingStatusRequestOfferingInstOfferingOwner.
     * 
     * @param subAccessCode
     */
    ...
    /**
     * Gets the acctAccessCode value for this ChangeOfferingStatusRequestOfferingInstOfferingOwner.
     * 
     * @return acctAccessCode
     */
    public com.huawei.www.bme.cbsinterface.bcservices.ChangeOfferingStatusRequestOfferingInstOfferingOwnerAcctAccessCode getAcctAccessCode() {
        return acctAccessCode;
    }


    /**
     * Sets the acctAccessCode value for this ChangeOfferingStatusRequestOfferingInstOfferingOwner.
     * 
     * @param acctAccessCode
     */
    public void setAcctAccessCode(com.huawei.www.bme.cbsinterface.bcservices.ChangeOfferingStatusRequestOfferingInstOfferingOwnerAcctAccessCode acctAccessCode) {
        this.acctAccessCode = acctAccessCode;
    }


    /**
     * Gets the custAccessCode value for this ChangeOfferingStatusRequestOfferingInstOfferingOwner.
     * 
    ...
    /**
     * Sets the custAccessCode value for this ChangeOfferingStatusRequestOfferingInstOfferingOwner.
     * 
    ...
    /**
     * Gets the subGroupAccessCode value for this ChangeOfferingStatusRequestOfferingInstOfferingOwner.
     * 
    ...
    /**
     * Sets the subGroupAccessCode value for this ChangeOfferingStatusRequestOfferingInstOfferingOwner.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ChangeOfferingStatusRequestOfferingInstOfferingOwner)) return false;
        ChangeOfferingStatusRequestOfferingInstOfferingOwner other = (ChangeOfferingStatusRequestOfferingInstOfferingOwner) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ChangeOfferingStatusRequestOfferingInstOfferingOwner.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>ChangeOfferingStatusRequest>OfferingInst>OfferingOwner"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>>ChangeOfferingStatusRequest>OfferingInst>OfferingOwner>AcctAccessCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
