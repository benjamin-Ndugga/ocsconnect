/**
 * QueryOfferingInstPropertyRequestOfferingOwner.java
 *
...
public class QueryOfferingInstPropertyRequestOfferingOwner  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode;

    private com.huawei.www.bme.cbsinterface.bcservices.QueryOfferingInstPropertyRequestOfferingOwnerAcctAccessCode acctAccessCode;
    ...
    public QueryOfferingInstPropertyRequestOfferingOwner() {
    }

    public QueryOfferingInstPropertyRequestOfferingOwner(
           com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode,
           com.huawei.www.bme.cbsinterface.bcservices.QueryOfferingInstPropertyRequestOfferingOwnerAcctAccessCode acctAccessCode,
    ...
    /**
     * Gets the subAccessCode value for this QueryOfferingInstPropertyRequestOfferingOwner.
     * 
    ...
    /**
     * Sets the subAccessCode value for this QueryOfferingInstPropertyRequestOfferingOwner.
     * 
     * @param subAccessCode
     */
    ...
    /**
     * Gets the acctAccessCode value for this QueryOfferingInstPropertyRequestOfferingOwner.
     * 
     * @return acctAccessCode
     */
    public com.huawei.www.bme.cbsinterface.bcservices.QueryOfferingInstPropertyRequestOfferingOwnerAcctAccessCode getAcctAccessCode() {
        return acctAccessCode;
    }


    /**
     * Sets the acctAccessCode value for this QueryOfferingInstPropertyRequestOfferingOwner.
     * 
     * @param acctAccessCode
     */
    public void setAcctAccessCode(com.huawei.www.bme.cbsinterface.bcservices.QueryOfferingInstPropertyRequestOfferingOwnerAcctAccessCode acctAccessCode) {
        this.acctAccessCode = acctAccessCode;
    }


    /**
     * Gets the custAccessCode value for this QueryOfferingInstPropertyRequestOfferingOwner.
     * 
    ...
    /**
     * Sets the custAccessCode value for this QueryOfferingInstPropertyRequestOfferingOwner.
     * 
    ...
    /**
     * Gets the subGroupAccessCode value for this QueryOfferingInstPropertyRequestOfferingOwner.
     * 
    ...
    /**
     * Sets the subGroupAccessCode value for this QueryOfferingInstPropertyRequestOfferingOwner.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryOfferingInstPropertyRequestOfferingOwner)) return false;
        QueryOfferingInstPropertyRequestOfferingOwner other = (QueryOfferingInstPropertyRequestOfferingOwner) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryOfferingInstPropertyRequestOfferingOwner.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">QueryOfferingInstPropertyRequest>OfferingOwner"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>QueryOfferingInstPropertyRequest>OfferingOwner>AcctAccessCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
