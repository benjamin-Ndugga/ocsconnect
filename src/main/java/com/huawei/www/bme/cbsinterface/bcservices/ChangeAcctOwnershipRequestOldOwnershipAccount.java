/**
 * ChangeAcctOwnershipRequestOldOwnershipAccount.java
 *
...
public class ChangeAcctOwnershipRequestOldOwnershipAccount  implements java.io.Serializable {
    private java.lang.String prepaidAcctKey;

    private java.lang.String postpaidAcctKey;

    public ChangeAcctOwnershipRequestOldOwnershipAccount() {
    }
    ...
    /**
     * Gets the prepaidAcctKey value for this ChangeAcctOwnershipRequestOldOwnershipAccount.
     * 
    ...
    /**
     * Sets the prepaidAcctKey value for this ChangeAcctOwnershipRequestOldOwnershipAccount.
     * 
    ...
    /**
     * Gets the postpaidAcctKey value for this ChangeAcctOwnershipRequestOldOwnershipAccount.
     * 
    ...
    /**
     * Sets the postpaidAcctKey value for this ChangeAcctOwnershipRequestOldOwnershipAccount.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ChangeAcctOwnershipRequestOldOwnershipAccount)) return false;
        ChangeAcctOwnershipRequestOldOwnershipAccount other = (ChangeAcctOwnershipRequestOldOwnershipAccount) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ChangeAcctOwnershipRequestOldOwnershipAccount.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>ChangeAcctOwnershipRequest>OldOwnership>Account"));
