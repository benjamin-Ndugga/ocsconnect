/**
 * JoinSuperGroupRequestMembers.java
 *
...
public class JoinSuperGroupRequestMembers  implements java.io.Serializable {
    /* 该GROUP加入超级集团 */
    private com.huawei.www.bme.cbsinterface.bccommon.SubGroupAccessCode subGroupAccessCode;

    public JoinSuperGroupRequestMembers() {
    }
    ...
    /**
     * Gets the subGroupAccessCode value for this JoinSuperGroupRequestMembers.
     * 
     * @return subGroupAccessCode   * 该GROUP加入超级集团
     */
    ...
    /**
     * Sets the subGroupAccessCode value for this JoinSuperGroupRequestMembers.
     * 
     * @param subGroupAccessCode   * 该GROUP加入超级集团
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof JoinSuperGroupRequestMembers)) return false;
        JoinSuperGroupRequestMembers other = (JoinSuperGroupRequestMembers) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(JoinSuperGroupRequestMembers.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">JoinSuperGroupRequest>members"));
