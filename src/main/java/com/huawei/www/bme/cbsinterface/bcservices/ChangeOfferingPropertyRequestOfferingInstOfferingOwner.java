/**
 * ChangeOfferingPropertyRequestOfferingInstOfferingOwner.java
 *
...
public class ChangeOfferingPropertyRequestOfferingInstOfferingOwner  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode;

    private com.huawei.www.bme.cbsinterface.bcservices.ChangeOfferingPropertyRequestOfferingInstOfferingOwnerAcctAccessCode acctAccessCode;
    ...
    public ChangeOfferingPropertyRequestOfferingInstOfferingOwner() {
    }

    public ChangeOfferingPropertyRequestOfferingInstOfferingOwner(
           com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode,
           com.huawei.www.bme.cbsinterface.bcservices.ChangeOfferingPropertyRequestOfferingInstOfferingOwnerAcctAccessCode acctAccessCode,
    ...
    /**
     * Gets the subAccessCode value for this ChangeOfferingPropertyRequestOfferingInstOfferingOwner.
     * 
    ...
    /**
     * Sets the subAccessCode value for this ChangeOfferingPropertyRequestOfferingInstOfferingOwner.
     * 
     * @param subAccessCode
     */
    ...
    /**
     * Gets the acctAccessCode value for this ChangeOfferingPropertyRequestOfferingInstOfferingOwner.
     * 
     * @return acctAccessCode
     */
    public com.huawei.www.bme.cbsinterface.bcservices.ChangeOfferingPropertyRequestOfferingInstOfferingOwnerAcctAccessCode getAcctAccessCode() {
        return acctAccessCode;
    }


    /**
     * Sets the acctAccessCode value for this ChangeOfferingPropertyRequestOfferingInstOfferingOwner.
     * 
     * @param acctAccessCode
     */
    public void setAcctAccessCode(com.huawei.www.bme.cbsinterface.bcservices.ChangeOfferingPropertyRequestOfferingInstOfferingOwnerAcctAccessCode acctAccessCode) {
        this.acctAccessCode = acctAccessCode;
    }


    /**
     * Gets the custAccessCode value for this ChangeOfferingPropertyRequestOfferingInstOfferingOwner.
     * 
    ...
    /**
     * Sets the custAccessCode value for this ChangeOfferingPropertyRequestOfferingInstOfferingOwner.
     * 
    ...
    /**
     * Gets the subGroupAccessCode value for this ChangeOfferingPropertyRequestOfferingInstOfferingOwner.
     * 
    ...
    /**
     * Sets the subGroupAccessCode value for this ChangeOfferingPropertyRequestOfferingInstOfferingOwner.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ChangeOfferingPropertyRequestOfferingInstOfferingOwner)) return false;
        ChangeOfferingPropertyRequestOfferingInstOfferingOwner other = (ChangeOfferingPropertyRequestOfferingInstOfferingOwner) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ChangeOfferingPropertyRequestOfferingInstOfferingOwner.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>ChangeOfferingPropertyRequest>OfferingInst>OfferingOwner"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>>ChangeOfferingPropertyRequest>OfferingInst>OfferingOwner>AcctAccessCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
