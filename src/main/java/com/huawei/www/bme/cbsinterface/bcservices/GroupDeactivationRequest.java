...
public class GroupDeactivationRequest  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bccommon.SubGroupAccessCode subGroupAccessCode;

    public GroupDeactivationRequest() {
    }
    ...
    /**
     * Gets the subGroupAccessCode value for this GroupDeactivationRequest.
     * 
    ...
    /**
     * Sets the subGroupAccessCode value for this GroupDeactivationRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GroupDeactivationRequest)) return false;
        GroupDeactivationRequest other = (GroupDeactivationRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GroupDeactivationRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", "GroupDeactivationRequest"));
