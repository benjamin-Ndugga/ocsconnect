/**
 * ChangeOfferingPropertyRequestOfferingInstProductInstAddProperty.java
 *
...
public class ChangeOfferingPropertyRequestOfferingInstProductInstAddProperty  extends com.huawei.www.bme.cbsinterface.bccommon.InstProperty  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bccommon.EffectMode effectiveTime;

    private java.lang.String expirationTime;

    public ChangeOfferingPropertyRequestOfferingInstProductInstAddProperty() {
    }
    ...
    /**
     * Gets the effectiveTime value for this ChangeOfferingPropertyRequestOfferingInstProductInstAddProperty.
     * 
    ...
    /**
     * Sets the effectiveTime value for this ChangeOfferingPropertyRequestOfferingInstProductInstAddProperty.
     * 
     * @param effectiveTime
     */
    ...
    /**
     * Gets the expirationTime value for this ChangeOfferingPropertyRequestOfferingInstProductInstAddProperty.
     * 
    ...
    /**
     * Sets the expirationTime value for this ChangeOfferingPropertyRequestOfferingInstProductInstAddProperty.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ChangeOfferingPropertyRequestOfferingInstProductInstAddProperty)) return false;
        ChangeOfferingPropertyRequestOfferingInstProductInstAddProperty other = (ChangeOfferingPropertyRequestOfferingInstProductInstAddProperty) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ChangeOfferingPropertyRequestOfferingInstProductInstAddProperty.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>>ChangeOfferingPropertyRequest>OfferingInst>ProductInst>AddProperty"));
