...
public class VoucherRechargeEnquiryResultRechargeLogRechargeBonus  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/cbs/accountmgr", ">>VoucherRechargeEnquiryResult>RechargeLog>RechargeBonus"));
