...
public class Gender implements java.io.Serializable {
    ...
    public static final Gender value1 = new Gender(_value1);
    public static final Gender value2 = new Gender(_value2);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", "Gender"));
    }
    /**
