...
public class BatchChangeOfferingPropertyRequestProductInstAddProperty  extends com.huawei.www.bme.cbsinterface.bccommon.InstProperty  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>BatchChangeOfferingPropertyRequest>ProductInst>AddProperty"));
