/**
 * QueryCustomerInfoResultAccountAcctInfoUserCustomer.java
 *
...
public class QueryCustomerInfoResultAccountAcctInfoUserCustomer  implements java.io.Serializable {
    ...
    public QueryCustomerInfoResultAccountAcctInfoUserCustomer() {
    }
    ...
    /**
     * Gets the custKey value for this QueryCustomerInfoResultAccountAcctInfoUserCustomer.
     * 
     * @return custKey
     */
    ...
    /**
     * Sets the custKey value for this QueryCustomerInfoResultAccountAcctInfoUserCustomer.
     * 
     * @param custKey
     */
    ...
    /**
     * Gets the custInfo value for this QueryCustomerInfoResultAccountAcctInfoUserCustomer.
     * 
     * @return custInfo
     */
    ...
    /**
     * Sets the custInfo value for this QueryCustomerInfoResultAccountAcctInfoUserCustomer.
     * 
     * @param custInfo
     */
    ...
    /**
     * Gets the individualInfo value for this QueryCustomerInfoResultAccountAcctInfoUserCustomer.
     * 
    ...
    /**
     * Sets the individualInfo value for this QueryCustomerInfoResultAccountAcctInfoUserCustomer.
     * 
    ...
    /**
     * Gets the orgInfo value for this QueryCustomerInfoResultAccountAcctInfoUserCustomer.
     * 
     * @return orgInfo
     */
    ...
    /**
     * Sets the orgInfo value for this QueryCustomerInfoResultAccountAcctInfoUserCustomer.
     * 
     * @param orgInfo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryCustomerInfoResultAccountAcctInfoUserCustomer)) return false;
        QueryCustomerInfoResultAccountAcctInfoUserCustomer other = (QueryCustomerInfoResultAccountAcctInfoUserCustomer) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryCustomerInfoResultAccountAcctInfoUserCustomer.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>>QueryCustomerInfoResult>Account>AcctInfo>UserCustomer"));
