...
public class VoucherRechargeBySeqRequestMsg  implements java.io.Serializable {
    ...
    private com.huawei.www.bme.cbsinterface.cbs.accountmgr.VoucherRechargeBySeqRequest voucherRechargeBySeqRequest;
    ...
    public VoucherRechargeBySeqRequestMsg(
           ...
           com.huawei.www.bme.cbsinterface.cbs.accountmgr.VoucherRechargeBySeqRequest voucherRechargeBySeqRequest) {
     ...
     */
    public com.huawei.www.bme.cbsinterface.cbs.accountmgr.VoucherRechargeBySeqRequest getVoucherRechargeBySeqRequest() {
        return voucherRechargeBySeqRequest;
    }
     ...
     */
    public void setVoucherRechargeBySeqRequest(com.huawei.www.bme.cbsinterface.cbs.accountmgr.VoucherRechargeBySeqRequest voucherRechargeBySeqRequest) {
        this.voucherRechargeBySeqRequest = voucherRechargeBySeqRequest;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/cbs/accountmgrmsg", ">VoucherRechargeBySeqRequestMsg"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/cbs/accountmgr", "VoucherRechargeBySeqRequest"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
