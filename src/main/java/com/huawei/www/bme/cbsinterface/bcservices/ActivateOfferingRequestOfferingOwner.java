/**
 * ActivateOfferingRequestOfferingOwner.java
 *
...
public class ActivateOfferingRequestOfferingOwner  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode;

    private com.huawei.www.bme.cbsinterface.bcservices.ActivateOfferingRequestOfferingOwnerAcctAccessCode acctAccessCode;
    ...
    public ActivateOfferingRequestOfferingOwner() {
    }

    public ActivateOfferingRequestOfferingOwner(
           com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode,
           com.huawei.www.bme.cbsinterface.bcservices.ActivateOfferingRequestOfferingOwnerAcctAccessCode acctAccessCode,
    ...
    /**
     * Gets the subAccessCode value for this ActivateOfferingRequestOfferingOwner.
     * 
    ...
    /**
     * Sets the subAccessCode value for this ActivateOfferingRequestOfferingOwner.
     * 
     * @param subAccessCode
     */
    ...
    /**
     * Gets the acctAccessCode value for this ActivateOfferingRequestOfferingOwner.
     * 
     * @return acctAccessCode
     */
    public com.huawei.www.bme.cbsinterface.bcservices.ActivateOfferingRequestOfferingOwnerAcctAccessCode getAcctAccessCode() {
        return acctAccessCode;
    }


    /**
     * Sets the acctAccessCode value for this ActivateOfferingRequestOfferingOwner.
     * 
     * @param acctAccessCode
     */
    public void setAcctAccessCode(com.huawei.www.bme.cbsinterface.bcservices.ActivateOfferingRequestOfferingOwnerAcctAccessCode acctAccessCode) {
        this.acctAccessCode = acctAccessCode;
    }


    /**
     * Gets the custAccessCode value for this ActivateOfferingRequestOfferingOwner.
     * 
    ...
    /**
     * Sets the custAccessCode value for this ActivateOfferingRequestOfferingOwner.
     * 
    ...
    /**
     * Gets the subGroupAccessCode value for this ActivateOfferingRequestOfferingOwner.
     * 
    ...
    /**
     * Sets the subGroupAccessCode value for this ActivateOfferingRequestOfferingOwner.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ActivateOfferingRequestOfferingOwner)) return false;
        ActivateOfferingRequestOfferingOwner other = (ActivateOfferingRequestOfferingOwner) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ActivateOfferingRequestOfferingOwner.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">ActivateOfferingRequest>OfferingOwner"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>ActivateOfferingRequest>OfferingOwner>AcctAccessCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
