/**
 * QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner.java
 *
...
public class QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode;

    private com.huawei.www.bme.cbsinterface.bcservices.QueryOfferingRentCycleResultOfferingRentCycleOfferingOwnerAcctAccessCode acctAccessCode;
    ...
    public QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner() {
    }

    public QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner(
           com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode,
           com.huawei.www.bme.cbsinterface.bcservices.QueryOfferingRentCycleResultOfferingRentCycleOfferingOwnerAcctAccessCode acctAccessCode,
    ...
    /**
     * Gets the subAccessCode value for this QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner.
     * 
    ...
    /**
     * Sets the subAccessCode value for this QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner.
     * 
     * @param subAccessCode
     */
    ...
    /**
     * Gets the acctAccessCode value for this QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner.
     * 
     * @return acctAccessCode
     */
    public com.huawei.www.bme.cbsinterface.bcservices.QueryOfferingRentCycleResultOfferingRentCycleOfferingOwnerAcctAccessCode getAcctAccessCode() {
        return acctAccessCode;
    }


    /**
     * Sets the acctAccessCode value for this QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner.
     * 
     * @param acctAccessCode
     */
    public void setAcctAccessCode(com.huawei.www.bme.cbsinterface.bcservices.QueryOfferingRentCycleResultOfferingRentCycleOfferingOwnerAcctAccessCode acctAccessCode) {
        this.acctAccessCode = acctAccessCode;
    }


    /**
     * Gets the custAccessCode value for this QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner.
     * 
    ...
    /**
     * Sets the custAccessCode value for this QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner.
     * 
    ...
    /**
     * Gets the subGroupAccessCode value for this QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner.
     * 
    ...
    /**
     * Sets the subGroupAccessCode value for this QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner)) return false;
        QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner other = (QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryOfferingRentCycleResultOfferingRentCycleOfferingOwner.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>QueryOfferingRentCycleResult>OfferingRentCycle>OfferingOwner"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>>QueryOfferingRentCycleResult>OfferingRentCycle>OfferingOwner>AcctAccessCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
