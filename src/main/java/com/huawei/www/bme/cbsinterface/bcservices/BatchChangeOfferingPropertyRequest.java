...
public class BatchChangeOfferingPropertyRequest  implements java.io.Serializable {
    ...
    private com.huawei.www.bme.cbsinterface.bcservices.BatchChangeOfferingPropertyRequestOfferingInstProperty offeringInstProperty;

    private com.huawei.www.bme.cbsinterface.bcservices.BatchChangeOfferingPropertyRequestProductInst productInst;
    ...
    public BatchChangeOfferingPropertyRequest(
           ...
           com.huawei.www.bme.cbsinterface.bcservices.BatchChangeOfferingPropertyRequestOfferingInstProperty offeringInstProperty,
           com.huawei.www.bme.cbsinterface.bcservices.BatchChangeOfferingPropertyRequestProductInst productInst,
     ...
     */
    public com.huawei.www.bme.cbsinterface.bcservices.BatchChangeOfferingPropertyRequestOfferingInstProperty getOfferingInstProperty() {
        return offeringInstProperty;
    }
     ...
     */
    public void setOfferingInstProperty(com.huawei.www.bme.cbsinterface.bcservices.BatchChangeOfferingPropertyRequestOfferingInstProperty offeringInstProperty) {
        this.offeringInstProperty = offeringInstProperty;
    }
     ...
     * @return productInst
     */
    public com.huawei.www.bme.cbsinterface.bcservices.BatchChangeOfferingPropertyRequestProductInst getProductInst() {
        return productInst;
    }
     ...
     * @param productInst
     */
    public void setProductInst(com.huawei.www.bme.cbsinterface.bcservices.BatchChangeOfferingPropertyRequestProductInst productInst) {
        this.productInst = productInst;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", "BatchChangeOfferingPropertyRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">BatchChangeOfferingPropertyRequest>OfferingInstProperty"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">BatchChangeOfferingPropertyRequest>ProductInst"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
