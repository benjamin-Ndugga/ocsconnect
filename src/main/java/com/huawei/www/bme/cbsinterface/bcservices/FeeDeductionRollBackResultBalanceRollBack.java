/**
 * FeeDeductionRollBackResultBalanceRollBack.java
 *
...
public class FeeDeductionRollBackResultBalanceRollBack  implements java.io.Serializable {
    private java.lang.String acctKey;

    private com.huawei.www.bme.cbsinterface.bccommon.BalanceChgInfo[] balanceChgInfo;

    public FeeDeductionRollBackResultBalanceRollBack() {
    }
    ...
    /**
     * Gets the acctKey value for this FeeDeductionRollBackResultBalanceRollBack.
     * 
     * @return acctKey
     */
    ...
    /**
     * Sets the acctKey value for this FeeDeductionRollBackResultBalanceRollBack.
     * 
     * @param acctKey
     */
    ...
    /**
     * Gets the balanceChgInfo value for this FeeDeductionRollBackResultBalanceRollBack.
     * 
    ...
    /**
     * Sets the balanceChgInfo value for this FeeDeductionRollBackResultBalanceRollBack.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FeeDeductionRollBackResultBalanceRollBack)) return false;
        FeeDeductionRollBackResultBalanceRollBack other = (FeeDeductionRollBackResultBalanceRollBack) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FeeDeductionRollBackResultBalanceRollBack.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">FeeDeductionRollBackResult>BalanceRollBack"));
