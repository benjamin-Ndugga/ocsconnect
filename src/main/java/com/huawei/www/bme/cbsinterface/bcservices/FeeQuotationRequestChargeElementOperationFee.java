/**
 * FeeQuotationRequestChargeElementOperationFee.java
 *
...
public class FeeQuotationRequestChargeElementOperationFee  implements java.io.Serializable {
    private java.lang.String operationCode;

    private com.huawei.www.bme.cbsinterface.bccommon.SimpleProperty[] operationProperty;

    public FeeQuotationRequestChargeElementOperationFee() {
    }
    ...
    /**
     * Gets the operationCode value for this FeeQuotationRequestChargeElementOperationFee.
     * 
    ...
    /**
     * Sets the operationCode value for this FeeQuotationRequestChargeElementOperationFee.
     * 
     * @param operationCode
     */
    ...
    /**
     * Gets the operationProperty value for this FeeQuotationRequestChargeElementOperationFee.
     * 
    ...
    /**
     * Sets the operationProperty value for this FeeQuotationRequestChargeElementOperationFee.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FeeQuotationRequestChargeElementOperationFee)) return false;
        FeeQuotationRequestChargeElementOperationFee other = (FeeQuotationRequestChargeElementOperationFee) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FeeQuotationRequestChargeElementOperationFee.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>FeeQuotationRequest>ChargeElement>OperationFee"));
