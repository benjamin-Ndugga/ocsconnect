/**
 * QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer.java
 *
...
public class QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer  implements java.io.Serializable {
    ...
    public QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer() {
    }
    ...
    /**
     * Gets the custKey value for this QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer.
     * 
     * @return custKey
     */
    ...
    /**
     * Sets the custKey value for this QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer.
     * 
     * @param custKey
     */
    ...
    /**
     * Gets the custInfo value for this QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer.
     * 
     * @return custInfo
     */
    ...
    /**
     * Sets the custInfo value for this QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer.
     * 
     * @param custInfo
     */
    ...
    /**
     * Gets the individualInfo value for this QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer.
     * 
    ...
    /**
     * Sets the individualInfo value for this QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer.
     * 
    ...
    /**
     * Gets the orgInfo value for this QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer.
     * 
     * @return orgInfo
     */
    ...
    /**
     * Sets the orgInfo value for this QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer.
     * 
     * @param orgInfo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer)) return false;
        QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer other = (QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryCustomerInfoResultSubGroupSubGroupInfoUserCustomer.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>>QueryCustomerInfoResult>SubGroup>SubGroupInfo>UserCustomer"));
