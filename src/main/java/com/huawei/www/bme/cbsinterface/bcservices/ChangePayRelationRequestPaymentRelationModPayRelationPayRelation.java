/**
 * ChangePayRelationRequestPaymentRelationModPayRelationPayRelation.java
 *
...
public class ChangePayRelationRequestPaymentRelationModPayRelationPayRelation  implements java.io.Serializable {
    ...
    private com.huawei.www.bme.cbsinterface.bcservices.ChangePayRelationRequestPaymentRelationModPayRelationPayRelationPaymentLimit paymentLimit;

    public ChangePayRelationRequestPaymentRelationModPayRelationPayRelation() {
    }
    ...
    public ChangePayRelationRequestPaymentRelationModPayRelationPayRelation(
           ...
           com.huawei.www.bme.cbsinterface.bcservices.ChangePayRelationRequestPaymentRelationModPayRelationPayRelationPaymentLimit paymentLimit) {
    ...
    /**
     * Gets the payRelationKey value for this ChangePayRelationRequestPaymentRelationModPayRelationPayRelation.
     * 
    ...
    /**
     * Sets the payRelationKey value for this ChangePayRelationRequestPaymentRelationModPayRelationPayRelation.
     * 
    ...
    /**
     * Gets the priority value for this ChangePayRelationRequestPaymentRelationModPayRelationPayRelation.
     * 
     * @return priority
     */
    ...
    /**
     * Sets the priority value for this ChangePayRelationRequestPaymentRelationModPayRelationPayRelation.
     * 
     * @param priority
     */
    ...
    /**
     * Gets the payRelExtRule value for this ChangePayRelationRequestPaymentRelationModPayRelationPayRelation.
     * 
    ...
    /**
     * Sets the payRelExtRule value for this ChangePayRelationRequestPaymentRelationModPayRelationPayRelation.
     * 
     * @param payRelExtRule
     */
    ...
    /**
     * Gets the onlyPayRelFlag value for this ChangePayRelationRequestPaymentRelationModPayRelationPayRelation.
     * 
    ...
    /**
     * Sets the onlyPayRelFlag value for this ChangePayRelationRequestPaymentRelationModPayRelationPayRelation.
     * 
    ...
    /**
     * Gets the paymentLimit value for this ChangePayRelationRequestPaymentRelationModPayRelationPayRelation.
     * 
     * @return paymentLimit
     */
    public com.huawei.www.bme.cbsinterface.bcservices.ChangePayRelationRequestPaymentRelationModPayRelationPayRelationPaymentLimit getPaymentLimit() {
        return paymentLimit;
    }


    /**
     * Sets the paymentLimit value for this ChangePayRelationRequestPaymentRelationModPayRelationPayRelation.
     * 
     * @param paymentLimit
     */
    public void setPaymentLimit(com.huawei.www.bme.cbsinterface.bcservices.ChangePayRelationRequestPaymentRelationModPayRelationPayRelationPaymentLimit paymentLimit) {
        this.paymentLimit = paymentLimit;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ChangePayRelationRequestPaymentRelationModPayRelationPayRelation)) return false;
        ChangePayRelationRequestPaymentRelationModPayRelationPayRelation other = (ChangePayRelationRequestPaymentRelationModPayRelationPayRelation) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ChangePayRelationRequestPaymentRelationModPayRelationPayRelation.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>>ChangePayRelationRequest>PaymentRelation>ModPayRelation>PayRelation"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>>>ChangePayRelationRequest>PaymentRelation>ModPayRelation>PayRelation>PaymentLimit"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
