/**
 * BatchOperationRequestBatchChangeServiceService.java
 *
...
public class BatchOperationRequestBatchChangeServiceService  extends com.huawei.www.bme.cbsinterface.cbs.businessmgr.Service  implements java.io.Serializable {
    /* Add/Delete/Modify */
    private com.huawei.www.bme.cbsinterface.cbs.businessmgr.OperationType operationType;

    public BatchOperationRequestBatchChangeServiceService() {
    }
    ...
    /**
     * Gets the operationType value for this BatchOperationRequestBatchChangeServiceService.
     * 
    ...
    /**
     * Sets the operationType value for this BatchOperationRequestBatchChangeServiceService.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BatchOperationRequestBatchChangeServiceService)) return false;
        BatchOperationRequestBatchChangeServiceService other = (BatchOperationRequestBatchChangeServiceService) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BatchOperationRequestBatchChangeServiceService.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", ">>BatchOperationRequest>BatchChangeService>Service"));
