/**
 * QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer.java
 *
...
public class QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer  implements java.io.Serializable {
    ...
    public QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer() {
    }
    ...
    /**
     * Gets the custKey value for this QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer.
     * 
     * @return custKey
     */
    ...
    /**
     * Sets the custKey value for this QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer.
     * 
     * @param custKey
     */
    ...
    /**
     * Gets the custInfo value for this QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer.
     * 
     * @return custInfo
     */
    ...
    /**
     * Sets the custInfo value for this QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer.
     * 
     * @param custInfo
     */
    ...
    /**
     * Gets the individualInfo value for this QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer.
     * 
    ...
    /**
     * Sets the individualInfo value for this QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer.
     * 
    ...
    /**
     * Gets the orgInfo value for this QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer.
     * 
     * @return orgInfo
     */
    ...
    /**
     * Sets the orgInfo value for this QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer.
     * 
     * @param orgInfo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer)) return false;
        QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer other = (QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryCustomerInfoResultSubscriberSubscriberInfoUserCustomer.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>>QueryCustomerInfoResult>Subscriber>SubscriberInfo>UserCustomer"));
