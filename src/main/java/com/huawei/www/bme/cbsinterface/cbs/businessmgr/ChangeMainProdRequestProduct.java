/**
 * ChangeMainProdRequestProduct.java
 *
...
public class ChangeMainProdRequestProduct  extends com.huawei.www.bme.cbsinterface.cbs.businessmgr.Product  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.cbs.businessmgr.BindSubscriberNo[] bindSubscriberNo;

    public ChangeMainProdRequestProduct() {
    }
    ...
    /**
     * Gets the bindSubscriberNo value for this ChangeMainProdRequestProduct.
     * 
    ...
    /**
     * Sets the bindSubscriberNo value for this ChangeMainProdRequestProduct.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ChangeMainProdRequestProduct)) return false;
        ChangeMainProdRequestProduct other = (ChangeMainProdRequestProduct) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ChangeMainProdRequestProduct.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", ">ChangeMainProdRequest>Product"));
