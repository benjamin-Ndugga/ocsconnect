/**
 * FeeQuotationResultAcctBalanceChangeList.java
 *
...
public class FeeQuotationResultAcctBalanceChangeList  implements java.io.Serializable {
    private java.lang.String acctKey;

    private com.huawei.www.bme.cbsinterface.bccommon.BalanceChgInfo[] balanceChgInfo;

    public FeeQuotationResultAcctBalanceChangeList() {
    }
    ...
    /**
     * Gets the acctKey value for this FeeQuotationResultAcctBalanceChangeList.
     * 
     * @return acctKey
     */
    ...
    /**
     * Sets the acctKey value for this FeeQuotationResultAcctBalanceChangeList.
     * 
     * @param acctKey
     */
    ...
    /**
     * Gets the balanceChgInfo value for this FeeQuotationResultAcctBalanceChangeList.
     * 
    ...
    /**
     * Sets the balanceChgInfo value for this FeeQuotationResultAcctBalanceChangeList.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FeeQuotationResultAcctBalanceChangeList)) return false;
        FeeQuotationResultAcctBalanceChangeList other = (FeeQuotationResultAcctBalanceChangeList) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FeeQuotationResultAcctBalanceChangeList.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">FeeQuotationResult>AcctBalanceChangeList"));
