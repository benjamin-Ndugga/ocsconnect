...
public class BatchChangeOfferingPropertyRequestMsg  implements java.io.Serializable {
    ...
    private com.huawei.www.bme.cbsinterface.bccustomizedservices.BatchChangeOfferingPropertyRequest batchChangeOfferingPropertyRequest;
    ...
    public BatchChangeOfferingPropertyRequestMsg(
           ...
           com.huawei.www.bme.cbsinterface.bccustomizedservices.BatchChangeOfferingPropertyRequest batchChangeOfferingPropertyRequest) {
     ...
     */
    public com.huawei.www.bme.cbsinterface.bccustomizedservices.BatchChangeOfferingPropertyRequest getBatchChangeOfferingPropertyRequest() {
        return batchChangeOfferingPropertyRequest;
    }
     ...
     */
    public void setBatchChangeOfferingPropertyRequest(com.huawei.www.bme.cbsinterface.bccustomizedservices.BatchChangeOfferingPropertyRequest batchChangeOfferingPropertyRequest) {
        this.batchChangeOfferingPropertyRequest = batchChangeOfferingPropertyRequest;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bccustomizedservices", ">BatchChangeOfferingPropertyRequestMsg"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bccustomizedservices", "BatchChangeOfferingPropertyRequest"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
