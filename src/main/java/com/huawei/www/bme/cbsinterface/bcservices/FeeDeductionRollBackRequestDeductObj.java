/**
 * FeeDeductionRollBackRequestDeductObj.java
 *
...
public class FeeDeductionRollBackRequestDeductObj  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode;

    private com.huawei.www.bme.cbsinterface.bcservices.FeeDeductionRollBackRequestDeductObjAcctAccessCode acctAccessCode;
    ...
    public FeeDeductionRollBackRequestDeductObj() {
    }

    public FeeDeductionRollBackRequestDeductObj(
           com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode,
           com.huawei.www.bme.cbsinterface.bcservices.FeeDeductionRollBackRequestDeductObjAcctAccessCode acctAccessCode,
    ...
    /**
     * Gets the subAccessCode value for this FeeDeductionRollBackRequestDeductObj.
     * 
    ...
    /**
     * Sets the subAccessCode value for this FeeDeductionRollBackRequestDeductObj.
     * 
     * @param subAccessCode
     */
    ...
    /**
     * Gets the acctAccessCode value for this FeeDeductionRollBackRequestDeductObj.
     * 
     * @return acctAccessCode
     */
    public com.huawei.www.bme.cbsinterface.bcservices.FeeDeductionRollBackRequestDeductObjAcctAccessCode getAcctAccessCode() {
        return acctAccessCode;
    }


    /**
     * Sets the acctAccessCode value for this FeeDeductionRollBackRequestDeductObj.
     * 
     * @param acctAccessCode
     */
    public void setAcctAccessCode(com.huawei.www.bme.cbsinterface.bcservices.FeeDeductionRollBackRequestDeductObjAcctAccessCode acctAccessCode) {
        this.acctAccessCode = acctAccessCode;
    }


    /**
     * Gets the custAccessCode value for this FeeDeductionRollBackRequestDeductObj.
     * 
    ...
    /**
     * Sets the custAccessCode value for this FeeDeductionRollBackRequestDeductObj.
     * 
    ...
    /**
     * Gets the subGroupAccessCode value for this FeeDeductionRollBackRequestDeductObj.
     * 
    ...
    /**
     * Sets the subGroupAccessCode value for this FeeDeductionRollBackRequestDeductObj.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FeeDeductionRollBackRequestDeductObj)) return false;
        FeeDeductionRollBackRequestDeductObj other = (FeeDeductionRollBackRequestDeductObj) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FeeDeductionRollBackRequestDeductObj.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">FeeDeductionRollBackRequest>DeductObj"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>FeeDeductionRollBackRequest>DeductObj>AcctAccessCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
