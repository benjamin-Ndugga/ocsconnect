/**
 * QuerySubInfoExToCubeRequestAccessInfo.java
 *
...
public class QuerySubInfoExToCubeRequestAccessInfo  implements java.io.Serializable {
    /* Entity ID type. 
     * 1:Customer ID.   
     * 2:Account ID.   
     * 3:Subscriber ID.   
    ...
    public QuerySubInfoExToCubeRequestAccessInfo() {
    }
    ...
    /**
     * Gets the objectIdType value for this QuerySubInfoExToCubeRequestAccessInfo.
     * 
    ...
    /**
     * Sets the objectIdType value for this QuerySubInfoExToCubeRequestAccessInfo.
     * 
    ...
    /**
     * Gets the objectId value for this QuerySubInfoExToCubeRequestAccessInfo.
     * 
    ...
    /**
     * Sets the objectId value for this QuerySubInfoExToCubeRequestAccessInfo.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QuerySubInfoExToCubeRequestAccessInfo)) return false;
        QuerySubInfoExToCubeRequestAccessInfo other = (QuerySubInfoExToCubeRequestAccessInfo) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QuerySubInfoExToCubeRequestAccessInfo.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">QuerySubInfoExToCubeRequest>AccessInfo"));
