...
public class ChangeCustInfoRequest  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bccommon.CustAccessCode custAccessCode;

    private com.huawei.www.bme.cbsinterface.bcservices.ChangeCustInfoRequestCustInfo custInfo;

    private com.huawei.www.bme.cbsinterface.bccommon.Address addressInfo;

    public ChangeCustInfoRequest() {
    }

    public ChangeCustInfoRequest(
           com.huawei.www.bme.cbsinterface.bccommon.CustAccessCode custAccessCode,
           com.huawei.www.bme.cbsinterface.bcservices.ChangeCustInfoRequestCustInfo custInfo,
    ...
    /**
     * Gets the custAccessCode value for this ChangeCustInfoRequest.
     * 
    ...
    /**
     * Sets the custAccessCode value for this ChangeCustInfoRequest.
     * 
    ...
    /**
     * Gets the custInfo value for this ChangeCustInfoRequest.
     * 
     * @return custInfo
     */
    public com.huawei.www.bme.cbsinterface.bcservices.ChangeCustInfoRequestCustInfo getCustInfo() {
        return custInfo;
    }


    /**
     * Sets the custInfo value for this ChangeCustInfoRequest.
     * 
     * @param custInfo
     */
    public void setCustInfo(com.huawei.www.bme.cbsinterface.bcservices.ChangeCustInfoRequestCustInfo custInfo) {
        this.custInfo = custInfo;
    }


    /**
     * Gets the addressInfo value for this ChangeCustInfoRequest.
     * 
     * @return addressInfo
     */
    ...
    /**
     * Sets the addressInfo value for this ChangeCustInfoRequest.
     * 
     * @param addressInfo
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ChangeCustInfoRequest)) return false;
        ChangeCustInfoRequest other = (ChangeCustInfoRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ChangeCustInfoRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", "ChangeCustInfoRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">ChangeCustInfoRequest>CustInfo"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
