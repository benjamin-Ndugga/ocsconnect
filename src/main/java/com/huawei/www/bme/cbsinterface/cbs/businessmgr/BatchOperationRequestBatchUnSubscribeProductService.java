/**
 * BatchOperationRequestBatchUnSubscribeProductService.java
 *
...
public class BatchOperationRequestBatchUnSubscribeProductService  implements java.io.Serializable {
    private java.lang.String id;

    private com.huawei.www.bme.cbsinterface.cbs.businessmgr.SimpleProperty[] simpleProperty;

    public BatchOperationRequestBatchUnSubscribeProductService() {
    }
    ...
    /**
     * Gets the id value for this BatchOperationRequestBatchUnSubscribeProductService.
     * 
     * @return id
     */
    ...
    /**
     * Sets the id value for this BatchOperationRequestBatchUnSubscribeProductService.
     * 
     * @param id
     */
    ...
    /**
     * Gets the simpleProperty value for this BatchOperationRequestBatchUnSubscribeProductService.
     * 
    ...
    /**
     * Sets the simpleProperty value for this BatchOperationRequestBatchUnSubscribeProductService.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BatchOperationRequestBatchUnSubscribeProductService)) return false;
        BatchOperationRequestBatchUnSubscribeProductService other = (BatchOperationRequestBatchUnSubscribeProductService) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BatchOperationRequestBatchUnSubscribeProductService.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", ">>>BatchOperationRequest>BatchUnSubscribe>Product>Service"));
