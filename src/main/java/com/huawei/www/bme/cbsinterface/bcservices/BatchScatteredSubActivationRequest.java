...
public class BatchScatteredSubActivationRequest  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bcservices.BatchScatteredSubActivationRequestSubBasicInfo subBasicInfo;
    ...
    public BatchScatteredSubActivationRequest(
           com.huawei.www.bme.cbsinterface.bcservices.BatchScatteredSubActivationRequestSubBasicInfo subBasicInfo,
     ...
     * @return subBasicInfo
     */
    public com.huawei.www.bme.cbsinterface.bcservices.BatchScatteredSubActivationRequestSubBasicInfo getSubBasicInfo() {
        return subBasicInfo;
    }
     ...
     * @param subBasicInfo
     */
    public void setSubBasicInfo(com.huawei.www.bme.cbsinterface.bcservices.BatchScatteredSubActivationRequestSubBasicInfo subBasicInfo) {
        this.subBasicInfo = subBasicInfo;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", "BatchScatteredSubActivationRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">BatchScatteredSubActivationRequest>SubBasicInfo"));
