/**
 * QueryRebateRequestOfferingOwner.java
 *
...
public class QueryRebateRequestOfferingOwner  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode;

    private com.huawei.www.bme.cbsinterface.bcservices.QueryRebateRequestOfferingOwnerAcctAccessCode acctAccessCode;
    ...
    public QueryRebateRequestOfferingOwner() {
    }

    public QueryRebateRequestOfferingOwner(
           com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode,
           com.huawei.www.bme.cbsinterface.bcservices.QueryRebateRequestOfferingOwnerAcctAccessCode acctAccessCode,
    ...
    /**
     * Gets the subAccessCode value for this QueryRebateRequestOfferingOwner.
     * 
    ...
    /**
     * Sets the subAccessCode value for this QueryRebateRequestOfferingOwner.
     * 
     * @param subAccessCode
     */
    ...
    /**
     * Gets the acctAccessCode value for this QueryRebateRequestOfferingOwner.
     * 
     * @return acctAccessCode
     */
    public com.huawei.www.bme.cbsinterface.bcservices.QueryRebateRequestOfferingOwnerAcctAccessCode getAcctAccessCode() {
        return acctAccessCode;
    }


    /**
     * Sets the acctAccessCode value for this QueryRebateRequestOfferingOwner.
     * 
     * @param acctAccessCode
     */
    public void setAcctAccessCode(com.huawei.www.bme.cbsinterface.bcservices.QueryRebateRequestOfferingOwnerAcctAccessCode acctAccessCode) {
        this.acctAccessCode = acctAccessCode;
    }


    /**
     * Gets the custAccessCode value for this QueryRebateRequestOfferingOwner.
     * 
    ...
    /**
     * Sets the custAccessCode value for this QueryRebateRequestOfferingOwner.
     * 
    ...
    /**
     * Gets the subGroupAccessCode value for this QueryRebateRequestOfferingOwner.
     * 
    ...
    /**
     * Sets the subGroupAccessCode value for this QueryRebateRequestOfferingOwner.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryRebateRequestOfferingOwner)) return false;
        QueryRebateRequestOfferingOwner other = (QueryRebateRequestOfferingOwner) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryRebateRequestOfferingOwner.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">QueryRebateRequest>OfferingOwner"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>QueryRebateRequest>OfferingOwner>AcctAccessCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
