...
public class CreateSuperGroupRequestSuperGroupAccessCode  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bccustomizedservices", ">CreateSuperGroupRequest>SuperGroupAccessCode"));
