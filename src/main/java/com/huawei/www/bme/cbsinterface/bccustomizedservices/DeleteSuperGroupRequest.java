...
public class DeleteSuperGroupRequest  implements java.io.Serializable {
    ...
    private com.huawei.www.bme.cbsinterface.bccustomizedservices.DeleteSuperGroupRequestSuperGroupAccess superGroupAccess;

    public DeleteSuperGroupRequest() {
    }

    public DeleteSuperGroupRequest(
           com.huawei.www.bme.cbsinterface.bccustomizedservices.DeleteSuperGroupRequestSuperGroupAccess superGroupAccess) {
     ...
     */
    public com.huawei.www.bme.cbsinterface.bccustomizedservices.DeleteSuperGroupRequestSuperGroupAccess getSuperGroupAccess() {
     ...
     */
    public void setSuperGroupAccess(com.huawei.www.bme.cbsinterface.bccustomizedservices.DeleteSuperGroupRequestSuperGroupAccess superGroupAccess) {
        this.superGroupAccess = superGroupAccess;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bccustomizedservices", "DeleteSuperGroupRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bccustomizedservices", ">DeleteSuperGroupRequest>SuperGroupAccess"));
