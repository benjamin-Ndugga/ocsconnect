/**
 * QueryGroupMemOffNetNumberRequest.java
 *
...
public class QueryGroupMemOffNetNumberRequest  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bccommon.SubAccessCode subAccessCode;

    public QueryGroupMemOffNetNumberRequest() {
    }
    ...
    /**
     * Gets the subAccessCode value for this QueryGroupMemOffNetNumberRequest.
     * 
    ...
    /**
     * Sets the subAccessCode value for this QueryGroupMemOffNetNumberRequest.
     * 
     * @param subAccessCode
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryGroupMemOffNetNumberRequest)) return false;
        QueryGroupMemOffNetNumberRequest other = (QueryGroupMemOffNetNumberRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryGroupMemOffNetNumberRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", "QueryGroupMemOffNetNumberRequest"));
