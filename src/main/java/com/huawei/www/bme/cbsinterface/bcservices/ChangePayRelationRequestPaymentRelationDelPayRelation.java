/**
 * ChangePayRelationRequestPaymentRelationDelPayRelation.java
 *
...
public class ChangePayRelationRequestPaymentRelationDelPayRelation  implements java.io.Serializable {
    private java.lang.String payRelationKey;

    private com.huawei.www.bme.cbsinterface.bccommon.EffectMode expirationTime;

    public ChangePayRelationRequestPaymentRelationDelPayRelation() {
    }
    ...
    /**
     * Gets the payRelationKey value for this ChangePayRelationRequestPaymentRelationDelPayRelation.
     * 
    ...
    /**
     * Sets the payRelationKey value for this ChangePayRelationRequestPaymentRelationDelPayRelation.
     * 
    ...
    /**
     * Gets the expirationTime value for this ChangePayRelationRequestPaymentRelationDelPayRelation.
     * 
    ...
    /**
     * Sets the expirationTime value for this ChangePayRelationRequestPaymentRelationDelPayRelation.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ChangePayRelationRequestPaymentRelationDelPayRelation)) return false;
        ChangePayRelationRequestPaymentRelationDelPayRelation other = (ChangePayRelationRequestPaymentRelationDelPayRelation) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ChangePayRelationRequestPaymentRelationDelPayRelation.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>ChangePayRelationRequest>PaymentRelation>DelPayRelation"));
