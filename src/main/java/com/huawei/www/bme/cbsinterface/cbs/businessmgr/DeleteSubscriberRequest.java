...
public class DeleteSubscriberRequest  implements java.io.Serializable {
    ...
    /**
     * Gets the subscriberNo value for this DeleteSubscriberRequest.
     * 
     * @return subscriberNo
     */
    ...
    /**
     * Sets the subscriberNo value for this DeleteSubscriberRequest.
     * 
     * @param subscriberNo
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", "DeleteSubscriberRequest"));
