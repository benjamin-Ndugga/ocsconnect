/**
 * ChangeCustOfferingRequestDelOffering.java
 *
...
public class ChangeCustOfferingRequestDelOffering  implements java.io.Serializable {
    private com.huawei.www.bme.cbsinterface.bccommon.OfferingKey offeringKey;

    public ChangeCustOfferingRequestDelOffering() {
    }
    ...
    /**
     * Gets the offeringKey value for this ChangeCustOfferingRequestDelOffering.
     * 
     * @return offeringKey
     */
    ...
    /**
     * Sets the offeringKey value for this ChangeCustOfferingRequestDelOffering.
     * 
     * @param offeringKey
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ChangeCustOfferingRequestDelOffering)) return false;
        ChangeCustOfferingRequestDelOffering other = (ChangeCustOfferingRequestDelOffering) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ChangeCustOfferingRequestDelOffering.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">ChangeCustOfferingRequest>DelOffering"));
