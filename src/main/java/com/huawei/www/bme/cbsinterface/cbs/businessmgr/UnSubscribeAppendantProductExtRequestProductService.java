/**
 * UnSubscribeAppendantProductExtRequestProductService.java
 *
...
public class UnSubscribeAppendantProductExtRequestProductService  implements java.io.Serializable {
    private java.lang.String id;

    private com.huawei.www.bme.cbsinterface.cbs.businessmgr.SimpleProperty[] simpleProperty;

    public UnSubscribeAppendantProductExtRequestProductService() {
    }
    ...
    /**
     * Gets the id value for this UnSubscribeAppendantProductExtRequestProductService.
     * 
     * @return id
     */
    ...
    /**
     * Sets the id value for this UnSubscribeAppendantProductExtRequestProductService.
     * 
     * @param id
     */
    ...
    /**
     * Gets the simpleProperty value for this UnSubscribeAppendantProductExtRequestProductService.
     * 
    ...
    /**
     * Sets the simpleProperty value for this UnSubscribeAppendantProductExtRequestProductService.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UnSubscribeAppendantProductExtRequestProductService)) return false;
        UnSubscribeAppendantProductExtRequestProductService other = (UnSubscribeAppendantProductExtRequestProductService) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UnSubscribeAppendantProductExtRequestProductService.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/cbs/businessmgr", ">>UnSubscribeAppendantProductExtRequest>Product>Service"));
