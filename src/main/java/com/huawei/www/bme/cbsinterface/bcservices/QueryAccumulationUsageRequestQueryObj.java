/**
 * QueryAccumulationUsageRequestQueryObj.java
 *
...
public class QueryAccumulationUsageRequestQueryObj  implements java.io.Serializable {
    ...
    private com.huawei.www.bme.cbsinterface.bcservices.QueryAccumulationUsageRequestQueryObjAcctAccessCode acctAccessCode;

    private com.huawei.www.bme.cbsinterface.bccommon.SubGroupAccessCode subGroupAccessCode;

    public QueryAccumulationUsageRequestQueryObj() {
    }
    ...
    public QueryAccumulationUsageRequestQueryObj(
           ...
           com.huawei.www.bme.cbsinterface.bcservices.QueryAccumulationUsageRequestQueryObjAcctAccessCode acctAccessCode,
    ...
    /**
     * Gets the custAccessCode value for this QueryAccumulationUsageRequestQueryObj.
     * 
    ...
    /**
     * Sets the custAccessCode value for this QueryAccumulationUsageRequestQueryObj.
     * 
    ...
    /**
     * Gets the subAccessCode value for this QueryAccumulationUsageRequestQueryObj.
     * 
    ...
    /**
     * Sets the subAccessCode value for this QueryAccumulationUsageRequestQueryObj.
     * 
     * @param subAccessCode
     */
    ...
    /**
     * Gets the acctAccessCode value for this QueryAccumulationUsageRequestQueryObj.
     * 
     * @return acctAccessCode
     */
    public com.huawei.www.bme.cbsinterface.bcservices.QueryAccumulationUsageRequestQueryObjAcctAccessCode getAcctAccessCode() {
        return acctAccessCode;
    }


    /**
     * Sets the acctAccessCode value for this QueryAccumulationUsageRequestQueryObj.
     * 
     * @param acctAccessCode
     */
    public void setAcctAccessCode(com.huawei.www.bme.cbsinterface.bcservices.QueryAccumulationUsageRequestQueryObjAcctAccessCode acctAccessCode) {
        this.acctAccessCode = acctAccessCode;
    }


    /**
     * Gets the subGroupAccessCode value for this QueryAccumulationUsageRequestQueryObj.
     * 
    ...
    /**
     * Sets the subGroupAccessCode value for this QueryAccumulationUsageRequestQueryObj.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryAccumulationUsageRequestQueryObj)) return false;
        QueryAccumulationUsageRequestQueryObj other = (QueryAccumulationUsageRequestQueryObj) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(QueryAccumulationUsageRequestQueryObj.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">QueryAccumulationUsageRequest>QueryObj"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.huawei.com/bme/cbsinterface/bcservices", ">>QueryAccumulationUsageRequest>QueryObj>AcctAccessCode"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
